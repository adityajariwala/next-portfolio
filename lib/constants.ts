...
export const EXPERIENCE = [
  {
    ...
    location: "Chicago, IL",
    period: "Present",
    description: "Leading development of AI/ML-powered cloud-native applications processing millions of daily transactions in financial services.",
    highlights: [
  ...
  },
  {
    ...
    location: "Remote",
    period: "2021 - 2023",
    description: "Developed ML-based insights and AI capabilities for enterprise Kubernetes platform (DKP).",
    highlights: [
  ...
  },
  {
    ...
    location: "Remote",
    period: "2019 - 2021",
    description: "Taught cutting-edge technologies including Linux, containers, Kubernetes, and open-source development to university students.",
    highlights: [
