            ...
            <CardContent>
              <div className="text-dark-200 space-y-4 leading-relaxed">
                <p>
                  ...
                  transactions. With a Master&apos;s degree in Computer Science from UT Austin
                  and a dual Bachelor&apos;s in CS and Mathematics from Purdue, I bring both
                  theoretical depth and practical expertise to every project.
                </p>
                <p>
                  ...
                  enterprise Kubernetes platforms at D2iQ, to my current role developing
                  scalable systems and predictive analytics in financial services. I&apos;ve
                  contributed to open-source healthcare projects like ChRIS, and built everything
                  from credit risk scoring systems to AI chatbots.
                </p>
                <p>
                  I specialize in the intersection of artificial intelligence, distributed systems,
                  and cloud-native architecture. Whether it&apos;s designing ML pipelines, optimizing
                  Kubernetes deployments, or building high-throughput APIs, I love solving complex
                  technical challenges that have real-world impact.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="text-dark-200 space-y-4 leading-relaxed">
                <p>
                  ...
                  solves problems but is also a joy to work with. My approach
                  combines:
                </p>
                <ul className="space-y-2 pl-6">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>User-First Thinking:</strong> Always keeping the
                      end user in mind when designing solutions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-neon-cyan mt-1">▹</span>
                    <span>
                      <strong>Continuous Learning:</strong> Staying updated with
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-neon-cyan mt-1">▹</span>
                    <span>
                      <strong>Collaboration:</strong> Working closely with teams
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-neon-cyan mt-1">▹</span>
                    <span>
                      <strong>Quality Over Quantity:</strong> Focusing on
                      well-tested, optimized solutions
                    </span>
                  </li>
                </ul>
              </div>
